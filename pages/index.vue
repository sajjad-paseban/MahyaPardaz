    ...
    export default defineComponent({
        ...
        data(){
            ...
            return {
                ...
                blogs: [],
                projects: [],
                project_description: 'شرکت دانش بنیان محیاپرداز یزد با تکیه بر دانش و توان متخصصین خود و تجربه همکاری با شهرداری‌های کشور، همینک سامانه یکپارچه شهرداری الکترونیک، تحت نام شهرنگار را بر پایه آخرین فناوریهای روز، بصورت فرایند و مکان محور Web Gis Bpms تولید و عرضه نموده است. این سامانه جهت اتوماسیون کامل فرایندهای شهرداری در حوزه های مختلف طراحی شده و در آن بیش از ۵۰ فرایند اصلی شهرداری در حوزه های زیر کاملا مکانیزه شده است.'
            }
        },
        setup(){
            useHead({
